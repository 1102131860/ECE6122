...
void chessComponent::setupTextureBuffers()
{
    ...
    if (std::regex_search(cTextureFile, matches, regexRule))
    {
        ...
        { // Chess board directory path
            cTextureFile = "FinalProject/Stone_Chess_Board/" + cTextureFile;
        }
        else
        { // Chess pieces directory path
            cTextureFile = "FinalProject/Chess/" + cTextureFile;
        }
...
{
    /**********************************************************************************/
    // Consider about cTPosition.needRender = false, put them aside the chessboard
    /**********************************************************************************/
